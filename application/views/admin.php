<?php $this->load->view("admin_header");?>
		<div id="content">
			<div class="a15">
				...
				<div class="a17">
					<div class="<?php echo $status==1?"link_button_red":"link_button";?> left"><a href="<?php echo site_url()?>/admin/index/1/_/_/0">已发布</a></div>
					<div class="<?php echo $status==2?"link_button_red":"link_button";?> left"><a href="<?php echo site_url()?>/admin/index/2/_/_/0">草稿箱</a></div>
					<div class="<?php echo $status==3?"link_button_red":"link_button";?> left"><a href="<?php echo site_url()?>/admin/index/3/_/_/0">回收站</a></div>
					<div style="clear:both;"></div>
				</div>
						...
						<tr class="a4 <?php echo $color?>">
							...
							<td style="width:25%;">
								<?php for($j=0;$j<count($list[$i]->tags);$j++):
											$tags=$list[$i]->tags;
								?>
								<a href="<?php echo site_url()?>/admin/index/<?php echo $status?>/<?php echo $tags[$j]->tag;?>" class="rightmenunochecked" style="font-size:12px;"><?php echo $tags[$j]->tag;?></a><?php echo $j==count($list[$i]->tags)-1?"":",";?>
								<?php endfor;?>
							</td>
