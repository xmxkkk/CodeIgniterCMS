...
<head>
	...
	<script type="text/javascript" charset="utf-8" src="<?php echo base_url()?>js/jquery-1.8.3.min.js"></script>
	<script type="text/javascript" charset="utf-8" src="<?php echo base_url()?>js/javascript.js"></script>
	<script type="text/javascript" charset="utf-8" src="<?php echo base_url()?>js/datetimepicker/jquery-ui.min.js"></script>
	<script type="text/javascript" charset="utf-8" src="<?php echo base_url()?>js/datetimepicker/datetimepicker.js"></script>
	<script type="text/javascript" charset="utf-8" src="<?php echo base_url()?>js/datetimepicker/caret.js"></script>
	<script>
		var URL='<?php echo base_url()?>js/ueditor/';
	</script>
