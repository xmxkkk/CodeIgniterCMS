<?php $this->load->view("admin_header");?>
		<form method="post" action="<?php echo site_url()?>/admin/update_admin"> 
		<div id="content" class="textalignleft">
			<div class="a15">
				<div>
					<div class="fontsize24 left"><?php echo $this->lang->line("site_settings")?></div>
					<div style="clear:both;"></div>
				</div>
				<div class="a18 pt15">	
					<div class="left w150"><?php echo $this->lang->line("site_title")?><font color=red>*</font></div>
					<div class="left w300">
				...
				<div class="a18 pt15">	
					<div class="left w150"><?php echo $this->lang->line("site_description")?></div>
					<div class="left w300">
				...
				<div class="a18 pt15">	
					<div class="left w150"><?php echo $this->lang->line("webmaster_nickname")?><font color=red>*</font></div>
					<div class="left w300">
				...
				<div class="a18 pt15">	
					<div class="left w150"><?php echo $this->lang->line("admin_account")?><font color=red>*</font></div>
					<div class="left w300">
				...
				<div class="a18 pt15">	
					<div class="left w150"><?php echo $this->lang->line("admin_password")?><font color=red>*</font></div>
					<div class="left w300">
				...
				<div class="a18 pt15">	
					<div class="left w150"><?php echo $this->lang->line("confirm_password")?><font color=red>*</font></div>
					<div class="left w300">
				...
				<div class="a18 pt15">	
					...
					<div class="left w300">
						<input type="submit" value="<?php echo $this->lang->line("save_the_settings")?>"/>
					</div>
					<div style="clear:both;"></div>
				</div>
			</div>
